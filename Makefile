...
SRCS = handle_errors.c map_setup.c check_validaty.c clean.c handle_window.c handle_image.c path_validity.c events.c utils.c moves.c \
moves_utils.c map_env_setup.c enemy_AI.c graphics_utils.c handle_end_game.c
